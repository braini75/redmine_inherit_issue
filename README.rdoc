...
== Configuration
1. Choose the custom field used with the plugin
2. Select "Do not show at root:" if the plugin should not search ancestors if the attribute is already set in current issue.